 ...
 */
class getBlaguesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BlaguesRepository' shared autowired service.
     *
     * @return \App\Repository\BlaguesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BlaguesRepository.php';

        return $container->privates['App\\Repository\\BlaguesRepository'] = new \App\Repository\BlaguesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
